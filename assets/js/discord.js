...
var channelData = [{
	...
	messages: [{
		...
		embedData: {
			...
			fields: [{
				name: '/documentation',
				value: 'search for documentation'
			}, {
				name: '/codesearch',
				value: 'search for code snippets'
			}, {
				name: '/help',
				value: 'Get a list of all the commands'
			}, {
				name: '/usage',
				value: 'Get a list of CPU and RAM usage'
			}, {
				name: '/github',
				value: 'search trough all of github'
			}, {
				name: '/about',
				value: 'beta, guser, deploy-git-release, datasearch, dbstats, add-shard, sAnnounce, reqinv, add-zone-record, get-msg'
			}, {
				name: '/invite',
				value: 'invite CodeSearch to your server'
			},{
				name: '/updates',
				value: 'see al the updates to the bot'
			},{
				name: '/youtube',
				value: 'search trough all of youtube'
			}]
		}
	}]
}, {
